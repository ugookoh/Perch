...
import { colors, dimensionAssert, y } from '../../Functions/Functions';
import { OnBoardingVector1, OnBoardingVector2, OnBoardingVector3 } from '../../Images/svgImages/onboardingResourses';
    ...
    render() {
        ...
        return (
            <>
                ...
                >
                    <View style={[styles.slide, { backgroundColor: colors.GREY_LIGHT }]}>
